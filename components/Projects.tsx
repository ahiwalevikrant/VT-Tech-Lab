...
export default function Projects() {
  return (
    <section id="work" className="mx-auto max-w-content px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <SectionHeading index="02" title="Client Case Studies & Live Work" />
      <p className="mt-4 max-w-[68ch] text-base sm:text-lg leading-relaxed text-slate-300">
        Real client products shipped and operating live. From high-conversion rental booking platforms to bilingual agri-commerce storefronts and student lead engines.
      </p>
      ...
      <div id="solutions" className="mt-24">
        <SectionHeading index="03" title="Advanced AI & Enterprise Systems" />
        <p className="mt-4 max-w-[68ch] text-lg leading-relaxed text-slate-300">
          Architectural deep dives into custom RAG knowledge pipelines, autonomous Telegram bots, and enterprise event-driven microservices.
        </p>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {featuredProjects.map((project) => (
            <div
              key={project.id}
              className="glass-card flex flex-col justify-between p-8 transition-all duration-300 hover:border-purple-400/60 hover:shadow-[0_0_30px_rgba(168,85,247,0.2)]"
            >
              <div>
